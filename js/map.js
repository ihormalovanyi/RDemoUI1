...
const MAP = (() => {
  ...
  /* захід на посадку — з моря, під кутом до берега, точно в Ель-Прат */
  const FLIGHT_IN  = 'M4746,-1630 C 3400,-800 2200,900 540,969';
  const FLIGHT_OUT = 'M540,969 C 2300,900 3500,-500 4746,-1630';
  const TAXI = [
